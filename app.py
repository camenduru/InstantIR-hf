...
with gr.Blocks() as demo:
    ...
    ### **Official 🤗 Gradio demo of InstantIR[![GitHub](https://img.shields.io/github/stars/instantX-research/InstantIR?style=social)](https://github.com/instantX-research/InstantIR)**
